...
console.log(`
           ...
           ${'_o8888888888'.yellow}${'88'.grey.bold}${'K_]'.bgBlack.white.bold}${'888888o'.grey.bold}
                   ...
                   ${'_=oooooooo'.yellow.bold}${'8888888888888888'.white.bold}${'88'.white}
                    ${'_o88=8888='.yellow.bold}=~${'88888888'.yellow.bold}===8${'888_'.white}    ${'@sida112'.cyan.underline} # ${colors.dim.bold(new Date().toLocaleDateString("en"))}
                    ${'~'.yellow.bold}   ${'=~~'.yellow.bold} ${'_o88888888='.yellow.bold}      ~~~      ${'SIDA'.bold} [${'v1.0'.underline}]
                            ${'~ o8=~88=~'.yellow.bold}           
    ...
    if (Boolean(debug) && debug !== "false") {
        ...
        setInterval(() => {
            ...
            console.log(`[${'STATUS'.magenta.bold}] | ${colors.bold('Time')}: [${colors.underline(time-count)}], ${colors.bold('Status')}: [${statusses}]`);
            count++;
        }, 1000);
    }
} else {
